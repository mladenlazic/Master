...
# v = [20,30]
vehiclesCapacity = parse_input_data.parseVehicleToArray(vehicles)
# g = [10,20,30]
...
if(method == "BF"):
	result = VRPBruteForce(locationsIndex, distanceBetweenLocations, distanceDepotFromLocations, goodsPerLocations, vehiclesCapacity)
	print(result)
else:
